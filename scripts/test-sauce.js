const
    buildTests = require('./build-tests'),
    ...
    completedJobs = [],
    runningJobIds = [],
    sauce = (process.env.SAUCE_USERNAME && process.env.SAUCE_ACCESS_KEY)
        ? new SauceLabs({ username: process.env.SAUCE_USERNAME, password: process.env.SAUCE_ACCESS_KEY })
        : null,
